        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          <div className="w-full lg:w-1/2">
            ...
            animationDelay: "0.3s"
              ...
              Horn Bigarella - Arquitetura & Urbanismo
            </h1>
            
            <p style={{
            animationDelay: "0.5s"
          }} className="section-subtitle mt-3 sm:mt-6 mb-4 sm:mb-8 leading-relaxed opacity-0 animate-fade-in text-gray-950 font-normal text-base sm:text-lg text-left">Transformamos ideias em soluções criativas e seguras
            ...
            animationDelay: "0.7s"
              ...
              <a href="#get-access" className="flex items-center justify-center group w-full sm:w-auto text-center bg-pulse-600 hover:bg-pulse-700 text-white transition-colors duration-300" style={{
              borderRadius: '1440px',
